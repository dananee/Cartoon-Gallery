...
class UnprotectedsubFolder2_2_4 extends StatefulWidget {
  const UnprotectedsubFolder2_2_4({Key? key}) : super(key: key);

  @override
  State<UnprotectedsubFolder2_2_4> createState() =>
      _UnprotectedsubFolder2_2_4State();
}

class _UnprotectedsubFolder2_2_4State extends State<UnprotectedsubFolder2_2_4> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_1/Folder_1/2.Biology_Foundation/5-7_Molecules/6.mature/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
