...
class UnprotectedsubFolder2_2_5 extends StatefulWidget {
  const UnprotectedsubFolder2_2_5({Key? key}) : super(key: key);

  @override
  State<UnprotectedsubFolder2_2_5> createState() =>
      _UnprotectedsubFolder2_2_5State();
}

class _UnprotectedsubFolder2_2_5State extends State<UnprotectedsubFolder2_2_5> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_1/Folder_1/2.Biology_Foundation/5-7_Molecules/7.Adults/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
