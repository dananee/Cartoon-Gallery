...
class UnprotectedsubFolder2_2_3 extends StatefulWidget {
  const UnprotectedsubFolder2_2_3({Key? key}) : super(key: key);

  @override
  State<UnprotectedsubFolder2_2_3> createState() =>
      _UnprotectedsubFolder2_2_3State();
}

class _UnprotectedsubFolder2_2_3State extends State<UnprotectedsubFolder2_2_3> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_1/Folder_1/2.Biology_Foundation/5-7_Molecules/6.Child/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
