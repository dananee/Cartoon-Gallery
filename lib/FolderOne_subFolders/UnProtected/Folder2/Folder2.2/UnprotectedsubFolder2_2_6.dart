...
class UnprotectedsubFolder2_2_6 extends StatefulWidget {
  const UnprotectedsubFolder2_2_6({Key? key}) : super(key: key);

  @override
  State<UnprotectedsubFolder2_2_6> createState() =>
      _UnprotectedsubFolder2_2_6State();
}

class _UnprotectedsubFolder2_2_6State extends State<UnprotectedsubFolder2_2_6> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_1/Folder_1/2.Biology_Foundation/5-7_Molecules/7.Children/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
