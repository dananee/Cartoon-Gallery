...
class UnprotectedsubFolder2_1_6 extends StatefulWidget {
  const UnprotectedsubFolder2_1_6({Key? key}) : super(key: key);

  @override
  State<UnprotectedsubFolder2_1_6> createState() =>
      _UnprotectedsubFolder2_1_6State();
}

class _UnprotectedsubFolder2_1_6State extends State<UnprotectedsubFolder2_1_6> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/MainFolder1_assets/Unprotected-Videos/Unprotected-video2_1_6/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
