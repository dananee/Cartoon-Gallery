...
class UnprotectedsubFolder2_1_5 extends StatefulWidget {
  const UnprotectedsubFolder2_1_5({Key? key}) : super(key: key);

  @override
  State<UnprotectedsubFolder2_1_5> createState() =>
      _UnprotectedsubFolder2_1_5State();
}

class _UnprotectedsubFolder2_1_5State extends State<UnprotectedsubFolder2_1_5> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_1/Folder_1/2.Biology_Foundation/1-4_Tower_(Atoms)/3.Real_science/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
