...
class UnprotectedsubFolder2_1_4 extends StatefulWidget {
  const UnprotectedsubFolder2_1_4({Key? key}) : super(key: key);

  @override
  State<UnprotectedsubFolder2_1_4> createState() =>
      _UnprotectedsubFolder2_1_4State();
}

class _UnprotectedsubFolder2_1_4State extends State<UnprotectedsubFolder2_1_4> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_1/Folder_1/2.Biology_Foundation/1-4_Tower_(Atoms)/2.Mature_atom/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
