...
class VideoFolderTwo extends StatefulWidget {
  ...
  VideoFolderTwo({required this.mainFolder, required this.subFolder, Key? key})
      : super(key: key);

  @override
  State<VideoFolderTwo> createState() => _VideoFolderTwoState();
}

class _VideoFolderTwoState extends State<VideoFolderTwo> {
  bool noVideos = false;
