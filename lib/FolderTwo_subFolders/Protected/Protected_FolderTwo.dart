...
import 'dart:convert';
import 'dart:ui';
import 'package:cartoon_gallery/FolderTwo_subFolders/Protected/ProtectedVideos_FolderTwo.dart';
import 'package:flutter/material.dart';
import '../../main.dart';
import 'package:virtual_keyboard_multi_language/virtual_keyboard_multi_language.dart';
import 'package:flutter/services.dart' show rootBundle;

class ProtectedFolderTwo extends StatefulWidget {
  const ProtectedFolderTwo({Key? key}) : super(key: key);

  @override
  State<ProtectedFolderTwo> createState() => _ProtectedFolderTwoState();
}

class _ProtectedFolderTwoState extends State<ProtectedFolderTwo> {
  String _value = "";
  List allImagesPath = [];
                                                                      ...
                                                                      onKeyPress:
                                                                        ...
                                                                        if (_value ==
                                                                          ...
                                                                          Navigator
                                                                            ...
                                                                            context,
                                                                            MaterialPageRoute(
                                                                              builder: (context) => ProtectedVideosFolderTwo(mainFolder: 2, subFolder: index + 1),
                                                                            ),
                                                                          );
                                                                        }
                                                                      },
