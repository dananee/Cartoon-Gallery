...
class UnprotectedSubFolder1_4 extends StatefulWidget {
  const UnprotectedSubFolder1_4({Key? key}) : super(key: key);

  @override
  State<UnprotectedSubFolder1_4> createState() =>
      _UnprotectedSubFolder1_4State();
}

class _UnprotectedSubFolder1_4State extends State<UnprotectedSubFolder1_4> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_2/Completed_lessons_in_icon_2_No_password_required/Level_1-Brain_computation_car/4.M_M_game'))
        .toList();
    setState(() {
      videoPath = assets;
    });
