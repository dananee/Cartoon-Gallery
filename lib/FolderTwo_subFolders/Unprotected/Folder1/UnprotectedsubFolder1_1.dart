...
import 'dart:convert';
import 'package:cartoon_gallery/FolderTwo_subFolders/Unprotected/Folder1/UnprotectedsubFolder1_1_1.dart';
...
class _UnprotectedSubFolder1_1State extends State<UnprotectedSubFolder1_1> {
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        ...
        'assets/MainFolder2_assets/Unprotected-Videos/Unprotected-video1_1/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
                                                  ...
                                                  index == 0
                                                      ? SizedBox(
                                                          ...
                                                          child:
                                                            ...
                                                            child: const Image(
                                                              image: AssetImage(
                                                                  "assets/MainFolder2_assets/UnprotectedFolder_assets/subfolder1_1-icon.png"),
                                                            ),
                                                          ),
                                                        )
                                                      : Container(),
