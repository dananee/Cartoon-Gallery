...
class UnprotectedSubFolder1_2_1 extends StatefulWidget {
  const UnprotectedSubFolder1_2_1({Key? key}) : super(key: key);

  @override
  State<UnprotectedSubFolder1_2_1> createState() =>
      _UnprotectedSubFolder1_2_1State();
}

class _UnprotectedSubFolder1_2_1State extends State<UnprotectedSubFolder1_2_1> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_2/Completed_lessons_in_icon_2_No_password_required/Level_1-Brain_computation_car/2.car_alarm_game/Treehouse_2/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
