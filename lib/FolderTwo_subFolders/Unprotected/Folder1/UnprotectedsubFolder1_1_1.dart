...
class UnprotectedSubFolder1_1_1 extends StatefulWidget {
  const UnprotectedSubFolder1_1_1({Key? key}) : super(key: key);

  @override
  State<UnprotectedSubFolder1_1_1> createState() =>
      _UnprotectedSubFolder1_1_1State();
}

class _UnprotectedSubFolder1_1_1State extends State<UnprotectedSubFolder1_1_1> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder for icon 2/Completed lessons in icon 2. No password required/Level 1 - Brain computation car/1. Brain Computation car Intro/Treehouse 1/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
