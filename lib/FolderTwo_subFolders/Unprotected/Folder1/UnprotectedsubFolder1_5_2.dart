...
class UnprotectedSubFolder1_5_2 extends StatefulWidget {
  const UnprotectedSubFolder1_5_2({Key? key}) : super(key: key);

  @override
  State<UnprotectedSubFolder1_5_2> createState() =>
      _UnprotectedSubFolder1_5_2State();
}

class _UnprotectedSubFolder1_5_2State extends State<UnprotectedSubFolder1_5_2> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_2/Completed_lessons_in_icon_2_No_password_required/Level_1-Brain_computation_car/5.king_and_general_either-or/1.Treehouse_3/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
