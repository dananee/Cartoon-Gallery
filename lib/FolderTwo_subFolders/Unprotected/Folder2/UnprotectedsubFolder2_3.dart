...
class UnprotectedSubFolder2_3 extends StatefulWidget {
  const UnprotectedSubFolder2_3({Key? key}) : super(key: key);

  @override
  State<UnprotectedSubFolder2_3> createState() =>
      _UnprotectedSubFolder2_3State();
}

class _UnprotectedSubFolder2_3State extends State<UnprotectedSubFolder2_3> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_2/Completed_lessons_in_icon_2_No_password_required/Level_2-Perception_series/3.Art_lesson_1/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
