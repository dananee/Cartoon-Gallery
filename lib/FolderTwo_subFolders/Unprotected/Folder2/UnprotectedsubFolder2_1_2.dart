...
class UnprotectedSubFolder2_1_2 extends StatefulWidget {
  const UnprotectedSubFolder2_1_2({Key? key}) : super(key: key);

  @override
  State<UnprotectedSubFolder2_1_2> createState() =>
      _UnprotectedSubFolder2_1_2State();
}

class _UnprotectedSubFolder2_1_2State extends State<UnprotectedSubFolder2_1_2> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_2/Completed_lessons_in_icon_2_No_password_required/Level_2-Perception_series/1.Intro_to_perception/2.teen_adults/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
