...
class UnprotectedSubFolder2_2_1_1 extends StatefulWidget {
  const UnprotectedSubFolder2_2_1_1({Key? key}) : super(key: key);

  @override
  State<UnprotectedSubFolder2_2_1_1> createState() =>
      _UnprotectedSubFolder2_2_1_1State();
}

class _UnprotectedSubFolder2_2_1_1State
    extends State<UnprotectedSubFolder2_2_1_1> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        ...
        'assets/MainFolder2_assets/Unprotected-Videos/Unprotected-video2_2_1_1/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
