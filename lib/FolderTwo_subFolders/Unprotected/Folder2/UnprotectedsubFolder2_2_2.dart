...
class UnprotectedSubFolder2_2_2 extends StatefulWidget {
  const UnprotectedSubFolder2_2_2({Key? key}) : super(key: key);

  @override
  State<UnprotectedSubFolder2_2_2> createState() =>
      _UnprotectedSubFolder2_2_2State();
}

class _UnprotectedSubFolder2_2_2State extends State<UnprotectedSubFolder2_2_2> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder_for_icon_2/Completed_lessons_in_icon_2_No_password_required/Level_2-Perception_series/2.intro_to_Art_lesson_1/1.Children/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
