...
import 'dart:convert';
import 'dart:ui';
import 'package:cartoon_gallery/FolderThree_subFolders/Protected/ProtectedVideos_FolderThree.dart';
import 'package:flutter/material.dart';
import 'package:virtual_keyboard_multi_language/virtual_keyboard_multi_language.dart';
import '../../main.dart';
import 'package:flutter/services.dart' show rootBundle;

class ProtectedFolderThree extends StatefulWidget {
  const ProtectedFolderThree({Key? key}) : super(key: key);

  @override
  State<ProtectedFolderThree> createState() => _ProtectedFolderThreeState();
}

class _ProtectedFolderThreeState extends State<ProtectedFolderThree> {
  String _value = "";
  List allImagesPath = [];
  ...
  loadImages() async {
    ...
    final assets = manifestMap.keys
        .where((String key) =>
            key.startsWith('assets/Folder_3/52_password_protected_folders/'))
        .toList();
    setState(() {
                                                                      ...
                                                                      onKeyPress:
                                                                        ...
                                                                        if (_value ==
                                                                          ...
                                                                          Navigator
                                                                            ...
                                                                            context,
                                                                            MaterialPageRoute(
                                                                              builder: (context) => ProtectedVideosFolderThree(mainFolder: 3, subFolder: index + 1),
                                                                            ),
                                                                          );
                                                                        }
                                                                      },
