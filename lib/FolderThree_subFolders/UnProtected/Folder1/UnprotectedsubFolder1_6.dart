...
class UnprotectedSubFolder1_6 extends StatefulWidget {
  const UnprotectedSubFolder1_6({Key? key}) : super(key: key);

  @override
  State<UnprotectedSubFolder1_6> createState() =>
      _UnprotectedSubFolder1_6State();
}

class _UnprotectedSubFolder1_6State extends State<UnprotectedSubFolder1_6> {
  List videoPath = [];
  ...
  getPath() async {
    ...
    final assets = manifestMap.keys
        .where((String key) => key.startsWith(
            'assets/Folder 3/Completed lessons icon 3. No password required/5. Neurotransmitters/6. Begin happy journaling/'))
        .toList();
    setState(() {
      videoPath = assets;
    });
